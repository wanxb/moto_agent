...
| # | 功能 | 状态 | 阶段 | 链接 |
|---|------|------|------|------|
| 001 | 多车管理 | ✔️ 已实现（待部署 T12） | Phase 2 P0 | [001-multi-vehicle/](001-multi-vehicle/) |
| — | 维修保养记录 | 🟡 概览 | Phase 2 P1 | [backlog.md](backlog.md#维修保养记录) |
| — | 定时提醒 | 🟡 概览 | Phase 2 P1 | [backlog.md](backlog.md#定时提醒保养保险) |
| — | 记录纠错/删除 | 🟡 概览 | Phase 2 P2 | [backlog.md](backlog.md#记录纠错删除) |
