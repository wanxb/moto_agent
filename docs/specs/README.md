...
| 018 | Google OAuth（PWA 第三方登录） | 📝 规格中 | Phase 3 P2 | [018-google-oauth/](018-google-oauth/) |
| 019 | 品牌与命名 | 📝 规格中 | Phase 2 P3 | [019-branding/](019-branding/) |
| 020 | 图片上传与多模态分析 | 📝 规格中 | Phase 4 P1 | [020-image-upload/](020-image-upload/) |
